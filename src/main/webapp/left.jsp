...
<body style="background: #f0f9fd;">
	<dl class="leftmenu">
		...
		<dd>
			...
			<ul class="menuson">
				<li class="active"><cite></cite><a href="right.jsp"
					target="rightFrame" onclick="getUserinfo()">用户信息</a><i></i></li>
				<li class="active"><cite></cite><a href="imgtable.jsp"
					target="rightFrame" onclick="">设备信息</a><i></i></li>
		...
		<dd>
			<div class="title">
				<span><img src="images/leftico02.png" /></span>水价管理
			</div>
			<ul class="menuson">
				<li><cite></cite><a href="#">水价设置</a><i></i></li>
		...
		<dd>
			<div class="title">
				<span><img src="images/leftico03.png" /></span>参数设置
			</div>
			<ul class="menuson">
		...
		<dd>
			<div class="title">
				<span><img src="images/leftico04.png" /></span>报表管理
			</div>
			<ul class="menuson">
				...
				<li><cite></cite><a href="date.jsp" target="rightFrame" onclick="getreportform()">数据统计</a><i></i></li>
